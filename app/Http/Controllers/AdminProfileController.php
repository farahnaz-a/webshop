...
class AdminProfileController extends Controller
{
    public function index(){
        ...
        return view('admin.profile',compact('profileImage'));
    }
    ...
    public function updateImage(Request $request,$id) 
    {
        ...
        if ($profileImage <= 0) 
        {
            ...
            $profile_image->save(); 
            return redirect()->route('admin.profile')->with('upload_image','Upload Image Successfully');    
        } 
        ...
        else 
        {
            ...
            return redirect()->route('admin.profile')->with('update_image','Update Image Successfully');    
        }
    }
    ...
    public function updateinfo(Request $request,$id) 
    {
        ...
        return redirect()->route('admin.profile')->with('update_info','Update Info Successfully');   
    ...
    public function updatepassword(Request $request) 
    {
        ...
        {
            return redirect()->route('admin.profile')->with('deny_pass','Current password is incorrect');
        }
